    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><i class="fa-solid fa-person-walking-luggage"></i> Day Promotion</h1>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    ...
                    <div class="callout callout-info">
                        <div class="row no-print">
                            <div class="col-12">
                                <a href="edithotels.php?id=<?php echo htmlspecialchars($hotel_id) ?>"><button class="btn btn-danger"><i class="fa-solid fa-angle-left"></i> Geri</button></a>

                                <a href="adddaypromotion.php?hotel_id=<?php echo htmlspecialchars($hotel_id) ?>"><button class="btn btn-primary"><i class="fa-solid fa-plus"></i> New Promotion</button></a>
                        ...
                        <div class='card-body'>
                            ...
                            <div class='card-body'>
                                <table class='table table-bordered table-striped'>
                                    ...
                                    <?php
                                    $sql = "SELECT DISTINCT d.*, c.contract_name FROM day_promotion d
                                    ...
                                    if ($result->num_rows > 0) { ?>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Accommodation Period Start</th>
                                                <th>Accommodation Period End</th>
                                                <th>Days Before</th>
                                                <th>Stay Nights</th>
                                                <th>Free Nights</th>
                                                <th>Days</th>
                                        ...
                                        <tbody>
                                            <?php while ($row = $result->fetch_assoc()) { ?>
                                                <tr>
                                                    ...
                                                    <td><?= htmlspecialchars(date("d-m-Y", strtotime($row["accommodation_period_start"]))) ?></td>
                                                    <td><?= htmlspecialchars(date("d-m-Y", strtotime($row["accommodation_period_end"]))) ?></td>
                                                    <td><?= htmlspecialchars($row["days_before"]) ?></td>
                                                    <td><?= htmlspecialchars($row["stay_nights"]) ?></td>
                                                    <td><?= htmlspecialchars($row["free_nights"]) ?></td>
                                                    <td><?php
                                                        $days = [];
                                                    ...
                                                    <td><?php
                                                        ...
                                                        $sql = "SELECT n.room_type_name
                                                                FROM nis_day_promotion p
                                                                JOIN nis_day_promotion_rooms r ON p.id = r.day_promotion_id 
                                                        ...
                                                        ?></td>
                                                    <td>
                                                        <a class='btn btn-info btn-sm' href="editdaypromotion.php?hotel_id=<?= $hotel_id ?>&id=<?= htmlspecialchars($row['id']) ?>&contract_id=<?= htmlspecialchars($row['contract_id']) ?>">
                            ...
                            if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_id'])) {
                                ...
                                $deleteSql = "DELETE FROM day_promotion WHERE id = ?";
                                $stmt = $baglanti->prepare($deleteSql);
                                $stmt->bind_param("i", $deleteId);

                                if ($stmt->execute()) {
                                    header("Location: daypromotion.php?hotel_id=$hotel_id&success=3");
                                    exit;
                                } else {
